...
const MemberAccountPage = () => {
    const [membersState, setMembersState, applicantsState, setApplicantsState] = useContext(MemberContext);
    ...
    return (
        <div className="p-6 max-w-[375px] font-poppins mx-auto">
            <h1 className="text-[28px] font-extrabold text-center mt-8 mb-6">MEMBER ACCOUNTS</h1>
            ...
            {isModalOpen && <MemberModal member={selectedApplicant} closeModal={closeModal} acceptHandler={handleAcceptApplicant} />}
        </div>
    );
}
